  ...
  <main class="employee-management">
    ...
    <div class="action-section">
      ...
      <button class="add-button" @click="handleAddEmployee">
        <img
          src="https://cdn.builder.io/api/v1/image/assets/c3e46d0a629546c7a48302a5db3297d5/580b8f10bc1ad9769a3aed213267f4211a64a8cc50c1c93efc50ca7ae69c8da2?apiKey=c3e46d0a629546c7a48302a5db3297d5"
          alt="" class="add-icon" />
        <span>Додати</span>
      </button>
    </div>
