...
<div class="size-selector">
    ...
    >
        ...
        :class="{ 'disabled-option': !variant.isAvailable }"
      >
        {{ variant.size }}
      </option>
    </select>
...
.size-dropdown option.disabled-option {
  color: #A0A0A0; /* Сірий колір для недоступних варіантів */
  background-color: #F6E7E7; /* Основний фон */
}
...
.cart-item {
  ...
  .item-image {
    width: 150px; /* Збільшено на 3px */
    height: 150px; /* Збільшено на 3px */
    object-fit: cover;
    border-radius: 8px;
    margin-right: 15px;
  }
  ...
  .item-title {
    ...
    font-weight: 700;
    font-size: 20px; /* Збільшено на 5px */
  }
